...
import { Heart, Shield, Users, Phone, Mail, MapPin, Menu, X } from "lucide-react";
  ...
  Rescue Now
          ...
          {showMenu && (
            <div className="md:hidden py-4 space-y-3">
              {["About", "Our Mission", "How to Help", "Contact"].map((item, idx) => {
              ...
              <button className="w-full bg-lime-500 text-white px-6 py-2 rounded-full font-medium hover:bg-lime-600 transition-colors">
                Rescue Now
              </button>
            </div>
          )}
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center bg-white/40 backdrop-blur-sm rounded-3xl border border-lime-100/50 p-12 shadow-2xl">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              StreetSathi connects compassionate people with street needing rescue and care.
              Together we’re building a safer, healthier community for our four-legged friends.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-lime-500 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl shadow-lime-500/30 hover:bg-lime-600 hover:scale-105 transition-all">
                Report a animal in Need
              </button>
              <button className="border-2 border-lime-500 text-lime-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-lime-50 transition-all">
                Donate Here
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 mt-16 max-w-2xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="backdrop-blur-md bg-white/60 p-6 rounded-2xl border border-lime-100"
                >
                  <div className="text-4xl font-bold text-lime-500 mb-2">{item.num}</div>
  ...
  <div className="max-w-7xl mx-auto">
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-600 max-w-2xl mx-auto">
        We’re a passionate team of animal lovers working to protect street dogs across Nepal. 
        <span className="text-lime-600 font-medium"> StreetSathi</span> was founded with a mission to connect compassion 
        with action rescuing, treating, and caring for our four-legged friends who deserve love and safety.
      </p>
    </div>
  </div>
</section>
      
      <section id="mission" className="py-20 px-4 `bg-gradient-to-b` from-white to-lime-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Protecting street dogs from harm and ensuring they receive proper care.
            </p>
          </div>
      ...
      <section id="help" className="py-20 px-4 bg-lime-500 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Help Save a Life Today
          </h2>
          <p className="text-xl text-lime-50 mb-8">
            Your action can make the difference between life and death for a streets in need.
          </p>
      ...
      <section id="contact" className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Have a animal in need? Reach out now.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { Icon: Phone, label: "Emergency Hotline", value: "+977 9700755269" },
              { Icon: Mail, label: "Email Us", value: "Divya69@gmail.com" },
      ...
      <footer className="bg-gray-900  text-white py-1 px-4 w-full ">
